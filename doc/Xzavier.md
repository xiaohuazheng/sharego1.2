...
3.2.3.	用户交互模块概要设计	7
3.2.4.	信息展示模块概要设计	7
3.2.5.	后台管理数据爬取模块概要设计	7
3.2.6.	服务端处理请求模块概要设计	7
3.2.7.	模块功能关系	8
3.3.	详细设计	8
3.3.1.	设计目的	8
3.3.2.	用户交互模块详细设计	9
3.3.3.	信息展示模块详细设计	11
3.3.4.	后台管理数据爬取模块详细设计	12
3.3.5.	服务端处理请求模块详细设计	14
3.4.	本章小结	15
4.	测试与验证	16
4.1.	测试效果	16
4.1.1.	Chrome运行效果	16
...
4.3.	用户交互模块测试	20
4.3.1.	注册登录功能测试用例	20
4.3.2.	评论收藏购买功能测试用例	21
4.3.3.	信息修改功能测试用例	21
4.3.4.	商品搜索功能测试用例	22
4.4.	后台管理模块测试	22
4.4.1.	数据爬取功能测试用例	22
4.4.2.	用户管理功能测试用例	23
4.4.3.	管理员管理功能测试用例	23
4.4.4.	商品信息管理功能测试用例	24
4.5.	服务端处理请求模块测试	24
4.5.1.	搜索请求处理测试用例	24
4.5.2.	注册登录请求处理测试用例	25
4.5.3.	评论或收藏请求处理测试用例	26
4.5.4.	数据爬取请求处理测试用例	26
4.6.	本章小结	27
5.	评价	28
5.1.	对项目开发过程的体会	28
5.1.1.	过程总结	28
...
2.2.	用户交互模块概要设计	39
2.3.	信息展示模块概要设计	40
2.4.	后台管理数据爬取模块概要设计	40
2.5.	服务端处理请求模块概要设计	40
3.	详细设计	41
3.1.	引言	41
3.1.1.	编写目的	41
3.1.2.	参考资料	41
...
3.2.	用户交互模块	58
3.2.1.	注册登录功能测试用例	58
3.2.2.	评论收藏购买功能测试用例	59
3.2.3.	信息修改功能测试用例	60
3.2.4.	商品搜索功能测试用例	60
3.3.	后台管理模块	61
3.3.1.	数据爬取功能测试用例	61
3.3.2.	用户管理功能测试用例	61
3.3.3.	管理员管理功能测试用例	62
3.3.4.	商品信息管理效果测试用例	62
3.4.	服务端处理请求模块	63
3.4.1.	搜索请求处理测试用例	63
3.4.2.	注册登录请求处理测试用例	64
3.4.3.	评论或收藏请求处理测试用例	64
3.4.4.	数据爬取请求处理测试用例	65
4.	测试结果分析	65
附录4 用户文档说明书	66
1.	网站描述	66
2.	使用说明	66
...
AJAX无刷新请求：AJAX无刷新请求，用户点击功能按钮触发事件，通过AJAX的GET/POST方法传递数据到服务端，服务端根据请求的路径路由分发各自的控制器，由控制器与数据库进行交流并产出反馈，最终反馈给AJAX，网页端根据返回的结果做出对应的页面交互。
总的来说，该模块的设计思想就是接收用户请求，路由分发控制器，作出回应，AJAX实现异步请求，请求成功后发送信号用户交互页面。
4)	逻辑流程
	注册逻辑流程
用户进入注册页面，填写信息，模块会判断用户填写信息是否符合规范，并同时向后台请求用户名是否已经存在。当用户名不存在且用户所有信息符合规范后，向服务端发送请求将信息加入数据库。如图3.7：

图3.7注册逻辑流程图
	登录逻辑流程
用户进入登陆页，填写信息，模块会判断用户填写信息是否符合规范，符合规范则向服务端发送请求将验证用户名密码是否正确，正确则改变网站状态为用户登录状态。如图3.8：

图3.8登录逻辑流程图
	信息修改逻辑流程
用户状态为已登录，进入信息修改页，点击功能按钮触发事件。模块会判断用户填写信息是否符合规范，服务端会判断用户原始密码是否正确，符合规范则向服务端发送请求将用户信息更新。如图3.9：

图3.9信息修改逻辑流程图
	评论逻辑流程
用户状态为已登录，进入评论页，输入评论信息，模块会判断输入信息是否符合规范，符合规范则允许用户进行下一步，用户点击功能按钮触发事件。模块向服务端发送请求将用户评论信息写入数据库，并实时展示在页面。如图3.10：

图3.10信息修改逻辑流程图
	搜索逻辑流程
用户输入关键词，点击功能按钮触发事件，模块向服务端发送请求，将请求到的数据返回给页面，页面将数据信息展示出来。如图3.11：

图3.11搜索逻辑流程图
	收藏逻辑流程
点击功能按钮触发事件，模块会判断用户是否为登录状态并对非登录状态作出提示。如果为已登录状态，模块会向服务端发送请求将用户收藏的商品信息写入数据库。如图3.12：
...
3)	设计方法
信息展示模块的核心是Node路由的跳转，在PC网页端要做出请求失败，请求数据暂无状态的反馈页面：
请求正常：快速响应页面，展示商品信息准确无误。
请求失败：显示友好的404页面，并提供正确的跳转链接。
请求数据暂无：显示友好的提示信息页面。并提供正确的跳转链接。
4)	逻辑流程
	商品信息跳转逻辑流程
用户输入URL或者点击跳转链接，模块发送请求，PC端根据返回数据显示不同页面。具体流程如图3.14：

图3.14商品信息跳转逻辑流程图
	评论信息跳转逻辑流程
用户输入URL或者点击跳转链接，模块判发送请求，PC端根据返回数据显示不同页面。具体流程如图3.15：

图3.15评论信息跳转逻辑流程图
	用户信息跳转逻辑流程
用户输入URL或者点击跳转链接，模块判断用户为登录状态则发送请求，PC端根据返回数据显示不同页面。具体流程如图3.16：

图3.16歌曲上传逻辑流程图
	品牌信息跳转逻辑流程
用户输入URL或者点击跳转链接，模块判发送请求，PC端根据返回数据显示不同页面。具体流程如图3.17：

图3.17品牌信息跳转逻辑流程图
5)	接口设计
该模块接口的设计遵循Node的路由设计规范，分发路由至控制器，deal和index提供信息展示的接口，通过export向外提供访问。
3.3.4.	后台管理数据爬取模块详细设计
1)	功能定义
后台管理数据爬取模块主要是提供管理员管理网站用户，爬取模板网站数据并写入本地，管理商品信息的功能模块，具体功能的定义如表3.4：
表3.4后台管理模块功能定义表
序号	功能点	功能点详细内容
ADMIN_USER	管理用户，设置管理员	增删管理员，删除用户等
ADMIN_CRAW	数据爬取	爬取目标网站商品信息写入数据库
ADMIN_DEAL	管理商品信息	修改商品信息等
2)	性能要求
...
4)	逻辑流程
	数据爬取逻辑流程
管理员点击功能按钮触发事件，模块向服务端发送请求，并开始对数据进行爬取、过滤，存入数据库，爬取成功则返回成功的信息。具体流程如图3.18：

图3.18数据爬取逻辑流程图
	用户管理逻辑流程
管理员对普通用户进行删除或者设置为管理员操作，超级管理员对普通管理员进行设为普通用户操作，模块发送请求至服务端，服务端操作数据后返回成功信息。具体流程如图3.19：

图3.19用户管理逻辑流程图
	商品信息管理逻辑流程
管理员触发功能按钮对商品信息进行修改，模块发送请求至服务端，服务端操作数据后返回成功信息。具体流程如图3.20：
...
3.3.5.	服务端处理请求模块详细设计
1)	功能定义
该模块接收PC网页端数据传输模块的请求并给予反馈，由于PC网页端要求实现用户注册登录、信息修改、网页跳转、商品搜索、品牌评论、收藏商品、点击购买、数据爬取、用户管理等功能，因此该模块要求完成搜索处理、数据处理、路由分发、结果反馈等功能。功能定义如表3.5：
表3.5服务端处理请求模块功能定义表
序号	功能点	功能点详细内容
...
2)	性能要求
该模块为系统的服务器部分，需要处理来自PC网页端的请求。基本要求是服务器能识别来自PC网页端的各种请求并给出正确的回应。能够在可接受的时间范围内对客户端请求作出回应。
3)	设计方法
服务器的设计采用Node.js 事件驱动， 非阻塞I/O 模型得以轻量和高效。就具体功能来说，设计如下：
搜索请求处理：当接收到PC网页端的请求后，解析出查询的关键词并对之进行处理，调用数据库访问接口，传入sql语句进行查询，然后传回封装好的查询结果，最后回传到PC网页端。
数据请求处理：对于用户注册登录、信息修改、品牌评论、收藏商品、数据爬取、用户管理等请求，同样，先解析接收到的请求信息，连接数据库查询，将结果进行封装后传回。
路由分发：网站各不同请求分发至不同的控制器进行处理，并对处理的结果返回至相应的PC网页端。
4)	逻辑流程
	搜索请求处理逻辑流程：
服务器解析出查询的关键词并对之进行处理，调用数据库访问接口，传入sql语句进行查询，然后传回封装好的查询结果，最后回传到PC网页端。流程如图3.21：

图3.21搜索请求处理逻辑流程图
	数据请求处理逻辑流程：
解析接收到的请求信息，连接数据库查询，将结果进行封装后返回给PC网页端。如图3.22：

图3.22数据请求处理逻辑流程图
	路由分发逻辑流程：
分发不同请求至不同的控制器进行处理，并对处理的结果返回至相应的PC网页端。流程如图3.23：

图3.23路由分发逻辑流程图
5)	接口设计
Route为服务器主要模块，分发路由。Model提供数据库方法，Mysql用于连接数据库。
3.4.	本章小结

本章根据系统的需求，从概要设计到详细设计逐步详述出整个系统的分支结构与模块关系，并对每个模块的功能作出了要求、以及阐述了系统重要功能的算法设计思想和逻辑流程，最后给出了各模块中的路由接口，基本上已经涵盖了系统的各个部分。系统的编码就是基于这部分的工作来完成的。
...
因为不同浏览器的兼容性问题，这里分别给出不同主流浏览器下的运行效果，之后的测试都在chrome浏览器下进行测试，之所以选择chrome，是因为它的市场占有率是非常高的，也是开发者最喜欢的开发环境。国内浏览器基本没有自己的内核，都是用的Chrome或者IE的，所以不再重复测试。
4.1.1.	Chrome运行效果
图4.1为PC网页端部分在Chrome上的运行效果：
 
图4.1 chrome下运行效果图
4.1.2.	IE运行效果
图4.2为PC网页端部分在IE上的运行效果：
 
图4.2 IE下运行效果图
4.1.3.	Firfox效果
图4.3为PC网页端部分在Firfox上的运行效果：
...
4.4.4.	商品信息管理功能测试用例
这里对管理员管理功能的各种状态和各种交互效果进行测试用例编写，具体见表4.11：
表4.11功能按钮动态效果测试用例表
测试用例ID	Admin4
测试用例名称	商品信息管理
前提条件	登录用户为管理员
操作	预期结果	实际结果	测试状态
鼠标hover商品	出现管理商品按钮	出现管理商品按钮	PASS
点击管理商品	跳转至管理商品页面，商品信息展示正确	跳转至管理商品页面，商品信息展示正确	PASS
输入框聚焦	内容可编辑	内容可编辑	PASS
输入不符合规范	提示输入不符合规范	提示输入不符合规范	PASS
点击修改	修改信息成功提示修改成功，失败则提示修改失败，请重试	修改信息成功提示修改成功，失败则提示修改失败，请重试	PASS

4.5.	服务端处理请求模块测试

该模块的测试主要是观察PC网页端模块的测试数据，被服务端接收后，在解析、查询、反馈这些环节是否出错。
4.5.1.	搜索请求处理测试用例
这里对服务端对搜索请求处理功能的测试用例编写，具体见表4.12：
表4.12搜索请求处理测试用例表
测试用例ID	Serv1
测试用例名称	搜索请求处理
前提条件	接收到PC网页端的搜索请求
输入	预期结果	实际结果	测试状态
PC端输入合理关键词搜索	正确解析出关键字，查询正确的表，得到正确的结果并封装了结果数据反馈给PC端	正确解析出关键字，查询正确的表，得到正确的结果并封装了结果数据反馈给PC端	PASS
PC端输入不合理关键词搜索	正确解析出歌手名关键字，查询正确的表，没有得到结果则返回空值给PC端	正确解析出歌手名关键字，查询正确的表，没有得到结果则返回空值给PC端	PASS
4.5.2.	注册登录请求处理测试用例
这里对服务端对注册登录请求处理功能的测试用例编写，信息修改，用户管理，商品管理等同理。具体见表4.13：
表4.13注册登录请求处理测试用例表
测试用例ID	Serv2
测试用例名称	注册登录请求处理
前提条件	接收到注册登录的请求
输入	预期结果	实际结果	测试状态
注册输入用户名	正确的解析用户名，查询正确的表，并返回用户名是否已存在的结果给PC端	正确的解析用户名，查询正确的表，并返回用户名是否已存在的结果给PC端	PASS
输入正确信息并点击注册	正确的解析用户名，邮箱，密码，插入正确的表，并返回成功的消息给PC端	正确的解析用户名，邮箱，密码，插入正确的表，并返回成功的消息给PC端	PASS
输入正确信息并点击登录	正确的解析用户名，密码，查询正确的表，并返回成功的消息给PC端	正确的解析用户名，密码，查询正确的表，并返回成功的消息给PC端	PASS
信息修改填入正确信息便点击修改	正确的解析原始密码，查询正确的表，插入数据到正确的表，并返成功是否给PC端	正确的解析原始密码，查询正确的表，插入数据到正确的表，并返成功是否给PC端	PASS
对用户进行删除或设置管理员	正确的解析用户信息，查询并更新正确的表，并返回成功是否给PC端	正确的解析用户信息，查询并更新正确的表，并返回成功是否给PC端	PASS
正确输入商品信息并点击修改	正确的解析商品信息，查询正确的表，更新数据，并返成功是否给PC端	正确的解析商品信息，查询正确的表，更新数据，并返成功是否给PC端	PASS
4.5.3.	评论或收藏请求处理测试用例
这里对服务端对评论或收藏请求处理功能的测试用例编写。具体见表4.14：
表4.14评论或收藏请求处理测试用例表
测试用例ID	Serv3
测试用例名称	评论、收藏
前提条件	接收到评论或收藏请求
输入	预期结果	实际结果	测试状态
正确输入评论信息并点击发布评论	正确的解析评论内容，评论人信息，评论时间，插入数据正确的表，并返成功是否给PC端	正确的解析评论内容，评论人信息，评论时间，插入数据正确的表，并返成功是否给PC端	PASS
点击收藏	正确的解析商品信息，收藏人信息，插入数据正确的表，并返成功是否给PC端	正确的解析商品信息，收藏人信息，插入数据正确的表，并返成功是否给PC端	PASS
4.5.4.	数据爬取请求处理测试用例
这里对服务端对评论或收藏请求处理功能的测试用例编写。具体见表4.15：
表4.15数据爬取请求处理测试用例表
测试用例ID	Case4
测试用例名称	数据爬取请求处理
前提条件	接收到数据爬取请求
输入	预期结果	实际结果	测试状态
点击爬取数据	爬取目标网站数据并存入正确的数据库，并返回成功与否给PC端。	爬取目标网站数据并存入正确的数据库，并返回成功与否给PC端。	PASS
...
2.2.	服务器功能描述
2.2.1.	服务端处理请求模块
	接收PC端的搜索查询请求，连接数据库进行查询并返回结果。
	接收PC端的注册登录请求，连接数据库并更新数据库信息。
	接收PC端的收藏、评论请求，连接数据库并更新数据库信息。
	接收PC端的数据爬取请求，在web站点下爬取目标网站数据并更新数据库信息。
	接收PC端的用户管理请求，连接数据库并更新数据库信息。
...
表3.1数据具体表现表
功能	输入	处理	输出
搜索商品	搜索关键词	传送关键词	服务器返回的查询结果
信息展示	网页路径	根据路径查询信息	服务器返回的查询结果
注册登录	用户信息	序列化信息并传送	服务器更新数据库并反馈
品牌评论	评论信息	传送相关信息	服务器更新数据库并反馈
收藏商品	商品ID	传送商品ID	服务器更新数据库并反馈
数据爬取	爬取的URL	爬取数据	服务器更新数据库并反馈
用户管理	用户信息	传送用户信息	服务器更新数据库并反馈
...
因为本项目没有部署到线上。所以需要搭建服务器环境，安装node，git控制台，输入以下命令，连接好数据库即可访问：
...
本系统包括PC网页端和服务端。PC网页端主要划分成3个模块：用户交互模块、信息展示模块和后台管理数据爬取模块。服务端主要用于处理客户端的请求，统一为一个模块：客户端请求处理模块。每个模块包含了相应的功能点，整个系统的结构如图1.1：
...
功能：后台管理模块主要是有管理员身份的用户对网站的普通用户以及其他管理员的管理，对网站商品的信息进行管理等。数据爬取模块是有管理员身份的用户点击相应功能按钮触发事件，对目标网站进行数据爬取，并存入数据库，等待PC端请求数据。具体如图2.3：
...
3.2.5.	流程逻辑
	注册逻辑流程
用户进入注册页面，填写信息，模块会判断用户填写信息是否符合规范，并同时向后台请求用户名是否已经存在。当用户名不存在且用户所有信息符合规范后，向服务端发送请求将信息加入数据库。如图3.1：

图3.1注册逻辑流程图
	登录逻辑流程
用户进入登陆页，填写信息，模块会判断用户填写信息是否符合规范，符合规范则向服务端发送请求将验证用户名密码是否正确，正确则改变网站状态为用户登录状态。如图3.2：

图3.2登录逻辑流程图
	信息修改逻辑流程
用户状态为已登录，进入信息修改页，点击功能按钮触发事件。模块会判断用户填写信息是否符合规范，服务端会判断用户原始密码是否正确，符合规范则向服务端发送请求将用户信息更新。如图3.3：

图3.3信息修改逻辑流程图
	评论逻辑流程
用户状态为已登录，进入评论页，输入评论信息，模块会判断输入信息是否符合规范，符合规范则允许用户进行下一步，用户点击功能按钮触发事件。模块向服务端发送请求将用户评论信息写入数据库，并实时展示在页面。如图3.4：

图3.4信息修改逻辑流程图
	搜索逻辑流程
用户输入关键词，点击功能按钮触发事件，模块向服务端发送请求，将请求到的数据返回给页面，页面将数据信息展示出来。如图3.5：

图3.5搜索逻辑流程图
	收藏逻辑流程
点击功能按钮触发事件，模块会判断用户是否为登录状态并对非登录状态作出提示。如果为已登录状态，模块会向服务端发送请求将用户收藏的商品信息写入数据库。如图3.6：
...
3.3.5.	流程逻辑
	商品信息跳转逻辑流程
用户输入URL或者点击跳转链接，模块发送请求，PC端根据返回数据显示不同页面。具体流程如图3.8：

图3.8商品信息跳转逻辑流程图
	评论信息跳转逻辑流程
用户输入URL或者点击跳转链接，模块判发送请求，PC端根据返回数据显示不同页面。具体流程如图3.9：

图3.9评论信息跳转逻辑流程图
	用户信息跳转逻辑流程
用户输入URL或者点击跳转链接，模块判断用户为登录状态则发送请求，PC端根据返回数据显示不同页面。具体流程如图3.10：

图3.10歌曲上传逻辑流程图
	品牌信息跳转逻辑流程
用户输入URL或者点击跳转链接，模块判发送请求，PC端根据返回数据显示不同页面。具体流程如图3.11： 
...
3.4.2.	功能
后台管理数据爬取模块主要是提供管理员管理网站用户，爬取模板网站数据并写入本地，管理商品信息的功能模块，具体功能的定义如表3.7：
表3.4后台管理模块功能定义列表
序号	功能点	功能点详细内容
ADMIN_USER	管理用户，设置管理员	增删管理员，删除用户等
ADMIN_CRAW	数据爬取	爬取目标网站商品信息写入数据库
...
3.4.5.	流程逻辑
	数据爬取逻辑流程
管理员点击功能按钮触发事件，模块向服务端发送请求，并开始对数据进行爬取、过滤，存入数据库，爬取成功则返回成功的信息。具体流程如图3.12：

图3.12数据爬取逻辑流程图
	用户管理逻辑流程
管理员对普通用户进行删除或者设置为管理员操作，超级管理员对普通管理员进行设为普通用户操作，模块发送请求至服务端，服务端操作数据后返回成功信息。具体流程如图3.13：

图3.13用户管理逻辑流程图
	商品信息管理逻辑流程
管理员触发功能按钮对商品信息进行修改，模块发送请求至服务端，服务端操作数据后返回成功信息。具体流程如图3.14：
...
3.5.	服务端处理请求模块详细设计
3.5.1.	模块描述
该模块接收PC网页端数据传输模块的请求并把处理结果反馈给PC网页端。
3.5.2.	功能
由于PC网页端要求实现用户注册登录、信息修改、网页跳转、商品搜索、品牌评论、收藏商品、点击购买、数据爬取、用户管理等功能，因此该模块要求完成搜索处理、数据处理、路由分发、结果反馈等功能。功能定义如表3.5：
表3.5服务端处理请求模块功能表
序号	功能点	功能点详细内容
SERV_SEARCH	搜索处理	从接收到的请求提取搜索关键字，搜索数据库并反馈
SERV_DATA	数据处理	从接收到的请求判断增删查改
...
3.5.5.	流程逻辑
	搜索请求处理逻辑流程：
服务器解析出查询的关键词并对之进行处理，调用数据库访问接口，传入sql语句进行查询，然后传回封装好的查询结果，最后回传到PC网页端。流程如图3.15：

图3.15搜索请求处理逻辑流程图
	数据请求处理逻辑流程：
解析接收到的请求信息，连接数据库查询，将结果进行封装后返回给PC网页端。如图3.16：

图3.16数据请求处理逻辑流程图
	路由分发逻辑流程：
分发不同请求至不同的控制器进行处理，并对处理的结果返回至相应的PC网页端。流程如图3.17： 
...
表2.4服务端处理请求模块测试计划表
测试功能	输入	预期结果
PC端输入合理关键词搜索	正确解析出关键字，查询正确的表，得到正确的结果并封装了结果数据反馈给PC端	正确解析出关键字，查询正确的表，得到正确的结果并封装了结果数据反馈给PC端
PC端输入不合理关键词搜索	正确解析出歌手名关键字，查询正确的表，没有得到结果则返回空值给PC端	正确解析出歌手名关键字，查询正确的表，没有得到结果则返回空值给PC端
注册输入用户名	正确的解析用户名，查询正确的表，并返回用户名是否已存在的结果给PC端	正确的解析用户名，查询正确的表，并返回用户名是否已存在的结果给PC端
输入正确信息并点击注册	正确的解析用户名，邮箱，密码，插入正确的表，并返回成功的消息给PC端	正确的解析用户名，邮箱，密码，插入正确的表，并返回成功的消息给PC端
输入正确信息并点击登录	正确的解析用户名，密码，查询正确的表，并返回成功的消息给PC端	正确的解析用户名，密码，查询正确的表，并返回成功的消息给PC端
信息修改填入正确信息便点击修改	正确的解析原始密码，查询正确的表，插入数据到正确的表，并返成功是否给PC端	正确的解析原始密码，查询正确的表，插入数据到正确的表，并返成功是否给PC端
对用户进行删除或设置管理员	正确的解析用户信息，查询并更新正确的表，并返回成功是否给PC端	正确的解析用户信息，查询并更新正确的表，并返回成功是否给PC端
正确输入商品信息并点击修改	正确的解析商品信息，查询正确的表，更新数据，并返成功是否给PC端	正确的解析商品信息，查询正确的表，更新数据，并返成功是否给PC端
正确输入评论信息并点击发布评论	正确的解析评论内容，评论人信息，评论时间，插入数据正确的表，并返成功是否给PC端	正确的解析评论内容，评论人信息，评论时间，插入数据正确的表，并返成功是否给PC端
点击收藏	正确的解析商品信息，收藏人信息，插入数据正确的表，并返成功是否给PC端	正确的解析商品信息，收藏人信息，插入数据正确的表，并返成功是否给PC端
点击爬取数据	爬取目标网站数据并存入正确的数据库，并返回成功与否给PC端。	爬取目标网站数据并存入正确的数据库，并返回成功与否给PC端。
...
3.3.4.	商品信息管理效果测试用例
这里对管理员管理功能的各种状态和各种交互效果进行测试用例编写，具体见表3。11：
表3.11商品信息管理测试用例表
测试用例ID	Admin4
测试用例名称	商品信息管理
前提条件	登录用户为管理员
...
该模块的测试主要是观察PC网页端模块的测试数据，被服务端接收后，在解析、查询、反馈这些环节是否出错。
3.4.1.	搜索请求处理测试用例
这里对服务端对搜索请求处理功能的测试用例编写，具体见表3.12：
表3.12搜索请求处理测试用例表
测试用例ID	Serv1
测试用例名称	搜索请求处理
前提条件	接收到PC网页端的搜索请求
...
3.4.2.	注册登录请求处理测试用例
这里对服务端对注册登录请求处理功能的测试用例编写，信息修改，用户管理，商品管理等同理。具体见表3.13：
表3.13注册登录请求处理测试用例表
测试用例ID	Serv2
测试用例名称	注册登录请求处理
前提条件	接收到注册登录的请求
...
3.4.3.	评论或收藏请求处理测试用例
这里对服务端对评论或收藏请求处理功能的测试用例编写，具体见表3.14：
表3.14评论或收藏请求处理测试用例表
测试用例ID	Serv3
测试用例名称	评论、收藏
前提条件	接收到评论或收藏请求
...
3.4.4.	数据爬取请求处理测试用例
这里对服务端对评论或收藏请求处理功能的测试用例编写。具体见表3.15：
表3.15数据爬取请求处理测试用例表
测试用例ID	Case4
测试用例名称	数据爬取请求处理
前提条件	接收到数据爬取请求
...
网站是一个基于网络爬虫的商品评论导购网站。网站前端具有户注册登录、信息修改、网页跳转、商品搜索、品牌评论、收藏商品、点击购买等功能。网站后台系统具有数据爬取、用户管理、商品信息管理等功能。
2.	使用说明
网站首页如图2.1：
